	...
	<div class="formbody">
			...
			<div id="usual1" class="usual">
				<div id="tab1" class="tabson">
					<form method="post" action="/receiveModifyPlan.do?plan_id=${requestScope.plan_id }&food_id=${requestScope.plan_food_id } ">
						<ul class="forminfo">
							<li style="margin-top: 20px;"><label for="name">原料名称<b>*</b></label>
								<div class="vocation">
									<input name="name" type="text" class="dfinput" readonly="readonly"
										value=${requestScope.name }  style="width: 344px;" />
								</div></li>
							<br />
							<br />
							<br />
							...
							<li><label for="name">原料单价<b>*</b></label>
								<div class="vocation">
									<input name="price" type="text" class="dfinput"
										value=${requestScope.price } style="width: 344px;" />
								</div></li>
							<br />
							<li><label for="name">原料数量<b>*</b></label>
								<div class="vocation">
									<input name="num" type="text" class="dfinput" 
										value=${requestScope.num } style="width: 344px;" />
								</div></li>
							<br />
