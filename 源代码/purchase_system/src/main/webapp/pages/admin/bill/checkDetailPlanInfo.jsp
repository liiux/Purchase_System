...
$(function() {
	$('#pagination').bootstrapPaginator({
		...
		pageUrl: function(type, page, current) {
			return '/checkDetailPlanInfo.do?pageNum=' + page;
		},
...
<body>
	...
	<form method="post" action="<%=basePath %>/jumpAddPlanInfo.do?plan_id=${requestScope.plan_id}">
	<br/>
		<label>&nbsp;&nbsp;&nbsp;</label><input class="btn" id="newPlan" type="submit"  value="增加" ></input>
	</form>
	<div class="rightinfo">
			...
			<tbody>
				<c:forEach items="${requestScope.pageInfo.list }" var="map"
					...
					<tr>
						...
						<td>${map.num }</td>
						<td>${map.price }</td>
						<td> <a href="<%=basePath %>/modifyPlanInfo.do?plan_id=${map.plan_id}&food_id=${map.plan_food_id}"
							class="tablelink"> 修改</a>
							<a food_id="${map.plan_food_id }" plan_id=${map.plan_id } id="delBtn" href="javascript:void(0)"
		...
		<br/>
	<form method="post" action="<%=basePath %>/setPlanCheck.do?plan_id=${requestScope.plan_id}">
	<label>&nbsp;&nbsp;</label><input id="newPlan" type="submit" class="btn" value="提交" ></input>
	</form>
