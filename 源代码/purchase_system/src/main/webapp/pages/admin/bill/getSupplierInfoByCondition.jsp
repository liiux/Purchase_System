...
$(function() {
	$('#pagination').bootstrapPaginator({
		...
		pageUrl: function(type, page, current) {
			return '/getSupplierInfoByCondition.do?pageNum=' + page;
		},
...
<body>
	...
	<div class="rightinfo">
		<div class="tools">
			<ul class="toolbar">
				<li id="batchDel"><span><img src="<%=basePath%>/images/t03.png" /></span>删除</li>
			</ul>

			<div class="toolbar1">
				<table>
					<form method="post" name="serch" action="<%=basePath%>/getSupplierInfoByCondition.do">
						<tr>
			...
			<tbody>
				<c:forEach items="${requestScope.pageInfo.list }" var="map"
					...
					<tr>
						...
						<td>${map.linkman }</td>
						<td>${map.phone }</td>
						<td><a supplier_id="${map.id }" id="delBtn" href="javascript:void(0)"
