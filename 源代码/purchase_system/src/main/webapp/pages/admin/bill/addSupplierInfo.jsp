	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			<div id="tab1" class="tabson">
				<form method="post" action="/addSupplierInfo.do">
					<ul class="forminfo">
						<li style="margin-top: 20px;"><label for="name">供应商名称<b>*</b></label>
							<div class="vocation">
								<input name="name" type="text" class="dfinput"
									placeholder="请填写供应商名称" style="width: 344px;" />
							</div></li>
						<br />
						<br />
						<br />
						<li><label for="name">供应商地址<b>*</b></label>
							<div class="vocation">
								<input name="address" type="text" class="dfinput"
									placeholder="请填写供应商地址" style="width: 344px;" />
							</div></li>
						<br />
						<li><label for="name">联系人<b>*</b></label>
							<div class="vocation">
								<input name="linkman" type="text" class="dfinput"
									placeholder="请填写联系人姓名" style="width: 344px;" />
							</div></li>
						<br />
						<li><label for="name">联系电话<b>*</b></label>
							<div class="vocation">
								<input name="phone" type="text" class="dfinput"
									placeholder="请填写联系电话" style="width: 344px;" />
							</div></li>
						<br />
